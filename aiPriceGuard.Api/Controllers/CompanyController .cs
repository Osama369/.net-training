...
namespace aiPriceGuard.Api.Controllers
{
    ...
    public class CompanyController : Controller
    {
      ...
      //  private readonly HelperMethods _helperMethods;
        string username = "";
        public CompanyController(IConfiguration configuration, AMDbContext aMDbContext, Context Context, IWebHostEnvironment _environment, IHttpContextAccessor httpContextAccessor)
        {
