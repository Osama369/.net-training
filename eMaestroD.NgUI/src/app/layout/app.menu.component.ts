                  ...
                  items: [
                    ...
                    { label: 'General Journal', routerLink: [APP_ROUTES.reports.accountReports.generalJournal] },
                    {
                      ...
                      items: [
                        ...
                        { label: 'Sales Man Ledger', routerLink: [APP_ROUTES.reports.accountReports.SalesManLedgerReport] },
                      ],
                    },
                    ...
                    { label: 'Item Expiry List ', routerLink: [APP_ROUTES.reports.accountReports.ItemExpiryList] },
                    ...
                    { label: 'Sale Claim', routerLink: [APP_ROUTES.reports.accountReports.SalemanWiseSaleReport] },
                  ],
                },
              ],
            },
