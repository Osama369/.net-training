              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { label: 'Item Expiry List Report', routerLink: [APP_ROUTES.reports.accountReports.ItemExpiryList] },
                    { label: 'SSR With Availability Report', routerLink: [APP_ROUTES.reports.accountReports.SSRWithAvailability] },
                    { label: 'Sales Man Ledger Report', routerLink: [APP_ROUTES.reports.accountReports.SalesManLedgerReport] },
                  ],
                },
              ],
            },
