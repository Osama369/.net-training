...
@Component({
  selector: 'app-invoice-wise-profit',
  templateUrl: './invoice-wise-profit.component.html',
  styleUrls: ['./invoice-wise-profit.component.scss']
})

export class InvoiceWiseProfitComponent {
  constructor(
  ...
  submit()
  {
    ...
    let locID = 0;
    this.reportService.runReportWith2Para("InvoiceWiseProfit",d1,d2,0,0).subscribe(data => {
