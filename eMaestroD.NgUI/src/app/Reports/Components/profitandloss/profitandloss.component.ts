...
export class ProfitandlossComponent {
  constructor(private authService : AuthService,
    ...
    public route : ActivatedRoute,private http: HttpClient, private sanitizer: DomSanitizer, private datePipe: DatePipe,private reportService: ReportService){}
  ...
  submit()
  {
    ...
    this.reportService.runReportWith2Para("ProfitAndLoss",d1,d2,0,0).subscribe(data => {
