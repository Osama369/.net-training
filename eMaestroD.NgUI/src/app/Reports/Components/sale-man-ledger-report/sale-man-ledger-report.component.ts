...
@Component({
  selector: 'app-sale-man-ledger-report',
  templateUrl: './sale-man-ledger-report.component.html',
  styleUrls: ['./sale-man-ledger-report.component.scss']
})

export class SaleManLedgerReportComponent {
  constructor(
 ...
 roleOnChange(roleID : any)
  ...
  submit() {
    ...
    this.reportService.runReportWith3Para("SalesManLedgerReport", d1, d2,this.selectedUser.UserID,0).subscribe(data => {
