...
@Component({
  selector: 'app-discount-claim',
  templateUrl: './discount-claim.component.html',
  styleUrls: ['./discount-claim.component.scss']
})
export class DiscountClaimComponent {
  constructor(
  ...
  submit() {
    ...
    this.reportService.runReportWith3Para("DiscountClaim", d1, d2, this.SelectedVendor.vendID, 0).subscribe(data => {
