...
@Component({
  selector: 'app-month-wise-party-sale',
  templateUrl: './month-wise-party-sale.component.html',
  styleUrls: ['./month-wise-party-sale.component.scss']
})
export class MonthWisePartySaleComponent {
  constructor(
  ...
  ngOnInit(): void {
    ...
    this.sharedDataService.getCustomers$().subscribe({
      next:(list=>{
        ...
        this.customersList= [...(list as {[key:string]: any})["enttityDataSource"]]
...
// }
  ...
  submit()
  {
    ...
    this.reportService.runReportWith3Para("MonthWisePartySale",d1,d2,this.selectedCustomer.cstID ,this.selectedLocation.LocationId).subscribe(data => {
