...
@Component({
  selector: 'app-bonus-claims',
  templateUrl: './bonus-claims.component.html',
  styleUrls: ['./bonus-claims.component.scss']
})
export class BonusClaimsComponent {
  constructor(
  ...
  submit() {
    ...
    this.reportService.runReportWith3Para("BonusClaim", d1, d2, this.SelectedVendor.vendID, 0).subscribe(data => {
