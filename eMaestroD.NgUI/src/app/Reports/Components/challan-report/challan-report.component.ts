...
export class ChallanReportComponent {
  constructor(
...
LoadLocations()
 ...
 onToDateChange(event: any):void{
  ...
  submit()
  {
    ...
    this.reportService.runReportWith4Para("ChallanReport",d1,d2,this.vFromSelected.invoiceVoucherNo, this.vToSelected.invoiceVoucherNo,this.selectedLocation.LocationId).subscribe(data => {
