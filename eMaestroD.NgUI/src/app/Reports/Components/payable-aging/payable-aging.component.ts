...
@Component({
  ...
  styleUrls: ['./payable-aging.component.scss']
})
export class PayableAgingComponent {
  constructor(
...
// }
  ...
  submit()
  {
    ...
    this.reportService.runReportWith4Para("PayableAging",d1,d2,this.SelectedVendor.vendID,0,this.selectedLocation.LocationId).subscribe(data => {
