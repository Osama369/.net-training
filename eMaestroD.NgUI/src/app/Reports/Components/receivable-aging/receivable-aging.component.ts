...
@Component({
  ...
  styleUrls: ['./receivable-aging.component.scss']
})
export class ReceivableAgingComponent {
  constructor(
...
// }
  ...
  submit()
  {
    ...
    this.reportService.runReportWith4Para("ReceivableAging",d1,d2,this.selectedCustomer.cstID ,0,this.selectedLocation.LocationId).subscribe(data => {
