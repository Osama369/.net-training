...
@Component({
  selector: 'app-receipt-journal',
  templateUrl: './receipt-journal.component.html',
  styleUrls: ['./receipt-journal.component.scss']
})
export class ReceiptJournalComponent {
  constructor(
...
// }
  ...
  submit()
  {
    ...
    this.reportService.runReportWith3Para("ReceiptJournal",d1,d2,this.selectedCustomer.cstID ,this.selectedLocation.LocationId).subscribe(data => {
