...
@Component({
  ...
  styleUrls: ['./bulk-receipt.component.scss']
})
...
// }
  ...
  submit()
  {
    ...
    this.reportService.runReportWith3Para("BulkReceipt",d1,d2,this.selectedUser.UserID ,this.selectedLocation.LocationId).subscribe(data => {
