...
@Component({
  selector: 'app-item-expiry-list',
  templateUrl: './item-expiry-list.component.html',
  styleUrls: ['./item-expiry-list.component.scss']
})

export class ItemExpiryListComponent {
  constructor(
  ...
  submit() {
    ...
    this.reportService.runReportWith3Para("ItemExpiryListReport", d1, d2, this.SelectedVendor.vendID, 0).subscribe(data => {
