...
import { ColumnTypes } from 'src/app/services/columnstypes';
...
@Component({
  selector: 'app-report-gird',
  templateUrl: './report-gird.component.html',
  styleUrls: ['./report-gird.component.css'],
  providers:[ConfirmationService,MessageService]
})


export class ReportGirdComponent {
