...
@Component({
  selector: 'app-tax-report-by-customer',
  templateUrl: './tax-report-by-customer.component.html',
  styleUrls: ['./tax-report-by-customer.component.css']
})
export class TaxReportByCustomerComponent {
  constructor(
