...
@Component({
  ...
  styleUrls: ['./salehistory.component.css']
})

export class SalehistoryComponent {
  constructor(private authService : AuthService,
    public bookmarkService: BookmarkService,
    public route : ActivatedRoute,private customerService:CustomersService,private locationService:LocationService, private http: HttpClient, private sanitizer: DomSanitizer, private datePipe: DatePipe,private reportService: ReportService){}
  ...
  submit()
  {
    ...
    this.reportService.runReportWith3Para("SaleHistory",d1,d2,this.SelectedCustomer.cstID,this.selectedLocation.locID).subscribe(data => {
