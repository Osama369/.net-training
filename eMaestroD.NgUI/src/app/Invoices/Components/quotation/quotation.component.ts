...
export class QuotationComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      this.invoiceService.getInvoicesList(16).subscribe(invoices => {
      ...
      this.authService.checkPermission('QuotationsDelete').subscribe((x:any)=>{
        ...
        if (confirm("Are you sure you want to delete this invoice?") == true) {
            ...
            this.invoiceService.deleteInvoice(invoiceNo).subscribe(asd => {
              this.toasterService.success("Quotation has been successfully deleted!");
                this.invoiceService.getInvoicesList(16).subscribe(invoices => {
                    this.invoices = invoices;
                    this.loading = false;
                });
    ...
    onChangePrint(e:any) {
     ...
     exportExcel() {
        ...
        import('xlsx').then((xlsx) => {
          ...
          this.saveAsExcelFile(excelBuffer, "Quotation");
        });
      }
