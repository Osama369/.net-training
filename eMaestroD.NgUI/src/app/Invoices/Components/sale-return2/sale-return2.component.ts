...
@Component({
  selector: 'app-sale-return2',
  templateUrl: './sale-return2.component.html',
  styleUrls: ['./sale-return2.component.scss']
})

export class SaleReturn2Component implements OnInit {
