...
@Component({
  selector: 'app-add-new-stock-shortage',
  templateUrl: './add-new-stock-shortage.component.html',
  styleUrls: ['./add-new-stock-shortage.component.scss'],
  providers:[ConfirmationService,MessageService]
})
export class AddNewStockShortageComponent implements OnInit{
